...
python train.py --model_name roberta-base --dataset sst2 --r 8 --lora_alpha 16 --target_modules query value key attention.output.dense --learning_rate 1e-3 --epochs 25 --batch_size 256 --weight_decay 1e-2
python train.py --model_name roberta-base --dataset trec --r 8 --lora_alpha 16 --target_modules query value key attention.output.dense --learning_rate 1e-3 --epochs 25 --batch_size 256 --weight_decay 1e-2
